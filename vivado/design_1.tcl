...
proc create_root_design { parentCell } {
  ...
  # Create instance: canny_core_0, and set properties
  set canny_core_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:canny_core:1.0 canny_core_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins canny_core_0/stream_in]
  ...
  connect_bd_intf_net -intf_net canny_core_0_stream_out [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins canny_core_0/stream_out]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins canny_core_0/s_axi_CTRL_BUS] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs canny_core_0/s_axi_CTRL_BUS/Reg] SEG_canny_core_0_Reg
